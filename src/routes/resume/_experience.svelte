<section class="experience">
    ...
    <section class="position">
        ...
        <section>
            ...
            <ul>
                <li>Published the client's first online originations experience, integrating an isolated React app into the existing Ruby on Rails site to accelerate delivery into production.</li>
